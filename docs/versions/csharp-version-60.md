...
> .NET Compiler Platform, better known by its codename "Roslyn", is a set of open-source compilers and code
> analysis APIs for C# and Visual Basic .NET languages from Microsoft.
